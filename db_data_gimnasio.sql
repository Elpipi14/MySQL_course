...
--(Aplicar los triggers para una simulacion pagos y reservas en el archivo db_script_vfst.sql. Despues insertas datos asi se acutualiza los trigger y guarda en sus historiales)----
